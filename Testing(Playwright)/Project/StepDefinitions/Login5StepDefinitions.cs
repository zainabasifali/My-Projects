...
{
    [Binding]
    public class Login5StepDefinitions :BaseClass
    {
        private IPage _page;
        ...
        [Given("fill correct username and keep password empty")]
        public async Task GivenFillCorrectUsernameAndKeepPasswordEmpty()
        {
